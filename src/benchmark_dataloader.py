...
def parse_args():
    ...
    parser.add_argument('--flow', default=False, type=bool, help='indicate select optical flow or not')
    ...
    parser.add_argument('--use_memory', default=False,
                       help='use multimodal fusion memory')
    parser.add_argument('--use_external', default=False, type=bool,
                       help='use memory as external info')
    parser.add_argument('--use_pred', default=False, type=bool,
                       help='use predictive contrastive loss.')
    parser.add_argument('--use_inst', default=False, type=bool,
                       help='use instance contrastive loss.')
    parser.add_argument('--use_img2img', default=False, type=bool,
                       help='compute img2img loss')
    parser.add_argument('--use_flow_both', default=False, type=bool,
                       help='training rgb->flow both pred and instance.')
    parser.add_argument('--flow_inst_only', default=False, type=bool,
    ...
    parser.add_argument('--train_ann_file', default='/datadrive/commondatasets/tartanair-release1/train_ann_debug.json', type=str)
    parser.add_argument('--val_ann_file', default=' ', type=str)
    parser.add_argument('--train_transform', default='', type=str)
    parser.add_argument('--train_transform_aug', default='TartanAirVideoTransformWithAugmentation', type=str)
